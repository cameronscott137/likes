<template>
    <article class="border-b-2 last:border-b border-gray-300">
        ...
        <div class="px-6 py-6">
            ...
            <div v-if="like.urls">
                <a class="block mb-2 flex items-center text-sm text-blue-500 hover:text-blue-700 underline group break-words" v-for="url in like.urls" :key="url.id" :href="url.expanded_url" target="_blank" @click.stop>
